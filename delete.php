...
<body>
   ...
   </div><table id='med-div' class='table table-dark' style='width:100%;'><thead class='thead-light'><tr><th>ID</th><th>Name</th><th>Company</th><th>OS</th><th>formfactor</th><th>price</th><th>Delete</th><th>Edit</th></tr></thead><tbody>";
    while($row = mysqli_fetch_array($result))
      {
      echo "<tr><td>".$row['mobileid'] . "</td><td> " . $row['name']. "</td><td> " . $row['mobcompany']. "</td><td> " .$row['mobos']."</td><td>". $row['formfactor']."</td><td>". $row['price']."</td><td><a class='confirmation' href='delete1.php?id=".$row['mobileid']."' class='confirmation text-danger'><i class='fas fa-trash fa-2x'></i></a></td><td><a href='edit.php?id=".$row['mobileid']."' class='text-primary'><i class='fas fa-edit fa-2x'></i></a></td></tr>"; //these are the fields that you have stored in your database table employee
